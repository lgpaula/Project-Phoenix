...
# Input image path
#img_path = sys.argv[1]
#Lucas - this line adds the source of the image
img_path = "images/000001.jpg"

# Rotation range
#rot_range = 360 if len(sys.argv) <= 2 else int(sys.argv[2])
#Lucas - this line changes the degrees
rot_range = 270
...
for ang in range(0, rot_range):
    ...
    """ Example of rotating an image along x-axis(Normal 2D) from 0 to 360 degree """
